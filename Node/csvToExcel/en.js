const en = {
  ...
  common: {
    ...
    loadingText3: "Map loading, please wait...",
    all: "All",
    ...
    operateTipResMsg: "Successful operation",
    tip: "Tips",
    ...
    editTipResMsg: ["Edit successfully!", "Edit failed!"],
    yes: "Yes",
    no: "No",
  ...
  menu: {
    ...
    equipment: {
      ...
      crewGroupMonitorTitle: "Genset group monitoring",
      ...
      fuelRecordTitle: "Fuel record",
      historyRecordTitle: "History record",
    ...
    operation: {
      ...
      remoteTuningTitle: "Remote parameter tuning",
      remoteTuningHistoryTitle: "Remote parameter tuning - history",
      remoteTuningOperationTitle: "Remote parameter tuning - operation",
      deteriorationAnalysisTitle: "Degradation Analysis",
      leaseGensetTitle: "Rental genset",
      crewCloudTitle: "Cloud communication",
    ...
    setting: {
      ...
      maintenanceStrategyAddTitle: "New maintenance strategy",
      maintenanceStrategyShowTitle: "View maintenance strategy",
      ...
      advertisementAppTitle: "APP advertising space",
      advertisementAppletTitle: "Applet advertising space",
    },
  },
  crewList: {
    searchListPlaceholder: [
      "Please select the affiliated project",
  ...
  layout: {
    ...
    helpCenter: {
      ...
      deleteWord: "delete",
      deleteConfirmTip: "Confirm to delete the document?",
      deleteResponseTip: "This document has been deleted",
      onShelf: "listing",
      onShelfConfirmTip: "Confirm to upload this document?",
      onShelfResponseTip: "The document is available",
      offShelf: "Unavailable",
      offShelfConfirmTip: "Confirm to remove the document?",
      offShelfResponseTip: "This document is not available",
      des: "There is no help document on the current page, please add a document",
      belongPage: "affiliated page",
      belongPageTip: "Please select the affiliated page",
      name: "Document name",
      nameTip: "Please fill in the document name",
      namePlaceholder: "Please enter a title within the cross",
  ...
  monitoringScreen: {
    buttonLabelList: ["Manage System", "O&M Platform"],
    columnsList: ["Project name", "Genset name", "content", "time", "status"],
    project: {
    ...
    genset: {
      ...
      operateStatusList: ["Run", "Fault", "Risk", "Stop", "Offline"],
      rentingStatusList: [
        "maintenance",
        "Under lease",
        "construction",
    ...
    map: {
      ...
      chart: {
        ...
        typeList2: ["Normal", "Fault", "Risk", "Stop", "Offline"],
        tipList: [
          "Autoplay paused",
          "Autoplay started",
          "The distribution map of intelligent equipment in China will be displayed automatically after XXs",
          "Autoplay has been stopped",
          "Click to start Autoplay",
          "Click to stop autoplay",
        ],
        clickToNation: "Click to skip",
      },
      curve: {
        title: "The Top10 number of intelligent equipment in the world",
        title2pre: "Provinces of China",
        title2back: "The Top15 number of intelligent equipment",
        dialogTitle: "Data details",
      },
      chartNation: {
    ...
    bottomTable: {
      ...
      hoverTitleList: [
        'Click to skip to the "Maintenance monitoring" page',
        'Click to skip to the "Project monitoring" page',
        'Click to skip to the "Genset monitoring" page',
      ],
    },
  },
  project: {
    ...
    warningDataTitle: ["Real-time alarm", "Maintenance reminder"],
    list: {
      searchForm: {
      ...
      tableColumns: [
        ...
        "Project start time",
        "Project end time",
        "Remaining time after expiration",
      ],
      addNewProject: "New project",
      expire: "Expiring projects",
      open: "Start project",
      close: "Completed project",
      openProjectTip: "Determine to open the project",
      openProjectTip2:
        "The start operation cannot be canceled. Please operate with caution.",
      closeProjectTip: "Conifrm to complete the project?",
      closeProjectTip2:
        "After completion, the project information cannot be edited and the operation cannot be cancelled. Please operate with caution.",
    },
    mouldPage: {
      listTitle: [
        "Project information",
      ...
      projectListPlaceholder: "Please select project",
      changeProject: "Switch project",
      infoItems: [
        "Project genset power (kW)",
        "Number of project gensets",
        "Project creation time",
        "Project address",
      ],
    },
    ItemTitles: [
      ...
      "project gensets",
      "Genset group setup",
      "Parallel genset configuration",
    ],
    operateTitle: ["New project", "Edit Project"],
    operateResTip: [
      "New project success!",
    ...
    projectForm: [
      ...
      "Power requirement",
      "Number of leased gensets",
      "Project rent",
      "Creation time",
      "Contract status",
    ],
    formTip: ["China", "global", "-", "RMB", ""],
    ...
    projectFormRules: [
      ...
      { required: "Please select the project address", reg: "" },
      {
        required: "Please select the start and end time for the project",
        reg: "",
      },
      {
        required: "Please input power requirements",
    ...
    projectDetails: {
      ...
      configLabel: [
        ...
        "Number of on-site failure completed (times)",
        "Number of on-site maintenance completed (times)",
        "Allowable over limit power time threshold (h)",
        "Allowable over contract power time threshold (h)",
        "Starting battery drop Maximum voltage limit (V)",
        "Maximum startup time limit (S)",
      ],
      configForm: [
        "Remote service times",
        "On-site failure service times",
        "On-site maintenance services times",
        "On-site failure completion times",
      ...
      configFormPlaceholder: [
        ...
        "Please enter the number of on-site service failures",
      ...
      contract: {
        ...
        deleteFileTip: [
          "Delete file",
          "Conifirm to delete the current file?",
      ...
      personnel: {
        operate: ["Add personnel", "Edit personnel"],
        userType: ["business", "Technology", "Group monitoring user"],
        tip: [
          "Add user success!",
          "Failed to add user, please resubmit!",
          "Edit user success!",
          "Failed to edit user, please resubmit!",
          "Delete personnel",
          "Confirm to delete the current project staff?",
      ...
      genset: {
        ...
        type: ["Configured", "Unconfigured", "Enabled", "Disabled"],
        title: [
          "Addition of genset",
          "All selectable gensets",
          "Selected gensets",
          "Removal of genset",
        ],
        label: ["Genset location", "Engine model", "power"],
        labelPlaceholder: [
          "Please select Genset location",
          "Please enter the engine model",
          "Minimum power",
          "Maximum power",
        ],
        tip: [
          "Genset added successfully!",
          "Failed to add genset, please resubmit!",
          "Genset removed successful!",
          "Failed to remove the genset, please try again!",
          "Confirm to remove Genset XX from the current project?",
        ],
        ...
        electronicFence: {
          ...
          labelPlaceholder: [
            "Please enter the center longitude",
            "Please enter the center latitude",
            "Please enter the fence radius",
          ],
          tip: [
            "Turn off the electronic fence",
            "Confirm to close the electronic fence of the current genset?",
          ],
        },
      },
      crewColumns: [
      ...
      editColumnTip: [
        "Only positive integers can be entered, the input format is incorrect!'",
        "It cannot be greater than rated power",
        "It cannot be greater than standby power",
        "It cannot be less  than limited power",
        "It cannot be less  than rated power",
      ],
      selectCrewColumns: [
        "Genset name",
        "Engine model",
      ...
      parallel: {
        operate: [
          "Creat new synchronization",
          "Relieve synchronization",
          "Add as host",
          "Add as extension",
        ],
        title: [
          "Adding parallel group",
          "Editing parallel group",
          "All gensets in current project",
        ...
        tip: [
          ...
          "One host must be set up in the parallel group!",
          "An extension must be set up in the parallel group!",
          "Add parallel group successfully!",
          "Failed to add parallel group, please resubmit!",
          "Edit parallel group successful!",
          "Failed to edit parallel group, please resubmit!",
          "Relieve synchronization successfully!",
          "Failed to relieve synchronization, please try again!",
          "Are you sure to cancel the current parallel?",
          "After the cancellation, the relevant parallel machine will be changed to the ' single unit ' state, which still exists in this project.",
        ],
      },
      parallelColumns: [
        "Host name",
    ...
    progressManage: {
      ...
      sheetFormLabel: {
        "01": ["Project No.", "Engineering Department personnel"],
      },
    },
    completionRecord: {
      title: [
      ...
      expensesFormPlaceholder: [
        "Please select an expenditure type",
        "Please select expenditure project",
        "Please enter the project amount",
        "Please enter expenditure descriptions",
        "Please select file",
      ],
      ...
      expensesTip: [
        ...
        "Add expenditure item success!",
        "Failed to add expenditure item, please resubmit!",
        "Edit expenditure item success!",
        "Failed to edit expenditure item, please resubmit!",
        "Delete expenditure items",
        "Are you sure to delete current expenditure?",
        "Delete expenditure item success!",
        "Failed to delete expenditure item, please resubmit!",
      ],
      expensesStatistics: [
    ...
    monitor: {
      ...
      gensetData: [
        ...
        "Offline",
        "Genset Number",
        "Number of parallel gensets",
        "Number of single genset",
      ...
      parametersItem: {
        0: [
          ...
          "Over limit power time(h)",
          "Starting battery voltage drop(V)",
          "Startup success time(S)",
          "",
        ],
        1: [
          "Maximum load intensity(%)",
          "The number of times the power limit is exceeded",
          "Average project load(kW)",
          "Maintain the completion rate(%)",
          "High water temperature alarm times",
          "",
        ],
        2: [
          "Cloud service replacement rate(%)",
        ...
        3: [
          "Project fuel consumption(g/kW·h)",
          "Total project fuel consumption(L)",
          "Project gas energy consumption(m³/kW·h)",
          "Total gas consumption of the project(m³)",
          "Total project power generation(kW·h)",
          "Over contract power time`(h)",
        ],
        4: [
      ...
      genset: {
        ...
        status: ["Offline", "Stop", "Warning", "Alarm", "Run"],
        ...
        dataItem: {
          ...
          15: ["Fuel usage", "Fuel consumption"],
      ...
      failure: {
        ...
        equipmentSearchLabel: [
          "Supports keyword search for fault description or confirmation person",
          "Failure time",
          "Processing result",
        ],
        operateLabel: [
          ...
          "Fault details",
          "Add power supply fault information",
          "Edit power supply fault information",
          "View power supply faults details",
        ],
        formLabel: [
        ...
        resultEnum: ["Normal", "Abnormal", "Others"],
        ...
        equipmentFailureListColumns: [
          ...
          "Failure time",
          "Corresponding unit",
          "Corresponding alarm description",
          "Processing result",
  ...
  equipmentManagement: {
    ...
    crewConfig: {
      ...
      powerLimitForm: {
        list: [
          "Long term power limitation of the genset",
          "Long term time limitation of the genset (24h)",
          "Enable the upper limit of limited power intake resistance",
          "High intake resistance Limited power (KW)",
      ...
      strategyConfigForm: {
        ...
        messageList: [
          "Please add Maintenance matters!",
          "Maintenance matters is null!",
        ],
        deleteTipList: ["Delete Maintenance matters", "Are you sure to delete"],
      },
      referenceDialog: {
        title: "Reference maintenance policy template information",
        title2: "Maintenance Policy Template",
        inputPlaceholder: [
          "Support maintenance policy name keyword search",
          "Please select engine brand",
          "Please select the main category of strategy",
        ],
        formLabel: ["All brand", "All Strategy"],
        selected: "selected",
        tab: ["base info"],
        tableTitle: "Maintenance matters",
        tip: "Tip : Select the left maintenance policy template to view the template details",
        buttonLabel:
          "Confirm that the template is referenced and replace the entered maintenance policy information",
        columnsList: [
          "maintenance policy name",
          "Engine Brand",
          "engine series",
          "beat length",
          "maintain the number of beats",
          "Maintenance Cycle Length",
          "number of maintenance periods",
          "long maintenance cycle",
          "policy primary backup classification",
        ],
      },
    },
    crewinfo: {
      ...
      searchList: ["Genset coding search", "Genset location screening"],
      searchListPlaceholder: [
        "Please enter the genset code",
        "Please select genset location",
      ],
          ...
          options: [
            ...
            { options: ["Controller Type", "IsControl", "Power system"] },
            {
              ...
              options: [
                ...
                "Programmable sensor 2",
                "Programmable sensor 3",
              ],
            },
          ],
        },
      ...
      dialog: {
        title: [
          "Add genset resume",
          "Edit genset resume",
          "Add Genset critical components",
        ],
    ...
    crewReport: {
      ...
      timeMatrixReport: {
        sourceDescribe: ["Data sources", "Acquire genset Info", "Manual input"],
        title: "Matrix analysis report of power time",
        tableItemList: ["3D matrix", "2D matrix"],
        descriptionsItems: [
          "Engine serial No.",
          "Engine model",
          "Engine brand",
      ...
      startingReliabilityReport: {
        reportTitle: "Tendency analysis report of genset starting reliability",
        echartsItems: [
          "Battery Voltage",
          "Water Temperature",
          "Oil pressure",
    ...
    crewDistribute: {
      ...
      searchList: ["Genset name", "Genset status", "Company name"],
      searchListPlaceholder: [
        "Please enter the genset name",
        "Please select the genset status",
    ...
    crewMonitor: {
      ...
      control: {
        title: "Control",
        list: ["Stop", "Mannual", "Auto", "Alarm reset", "Start"],
        handleControl: [
      ...
      crewLocationLabels: "Genset location",
    ...
    alertHistory: {
      ...
      dialog: ["Genset name", "Alarm time", "Alarm name"],
      columns: ["content", "type", "Start time", "End time"],
      operateLabel: "View log curve",
      typeOpt: ["All", "Warning", "Stop"],
    },
    onlineRecord: {
      columns: ["Genset name", "type", "time"],
      typeOpt: ["All", "Offline", "Online"],
    },
    generationEnergyStatistics: {
      ...
      tooltip: [
        "Cumulative Power Generation one day",
        "Cumulative Running Time one day",
      ],
    },
    historicCurve: {
    ...
    alarmCurve: {
      testType: [
        ...
        "Alarm-High cooling water temperature",
        "Alarm-High oil temperature",
        "Alarm-Generator current overload",
        ...
        "Alarm-Downtime failed",
        "Alarm-Closing failure",
        "Alarm-Open failure",
        "Alarm-Emergency stop",
        "Alarm-Generator over frequency",
        "Alarm-Generator overpower",
        "Alarm-Generator current overcurrent",
        "Alarm-Generator undervoltage",
        "Alarm-Engine Underspeed",
        "Alarm-ECU Malfunction Alarm",
        "Delivery acceptance test",
        "Emergency power cycle test",
        "Troubleshooting-Start Failure Test",
        "Quick request for repair",
        "Boot record",
        "Log-start",
        "Log-down",
        ...
        "Log-open",
        "Log-Boot Inspection",
        "Log-downtime Inspection",
        "Factory test",
      ],
    },
    crewGroupMonitor: {
      title: "Genset group monitoring",
      topLabelList: ["Active Power", "Generating capacity", "Current time"],
      clickToMonitor: "Click link to genset monitor",
      bottomLabelList: [
        "Current",
        "Phase voltage",
        "Line voltage",
  ...
  settingManagement: {
    maintenanceStrategy: {
      ...
      tipList: ["Confirm", "this Strategy"],
    },
    advertisement: {
      nameList: ["Applet", "Home carousel pictures"],
      formLabelList: [
        "Type of picture",
        "Name of picture",
        "Upload pictures",
      ...
      errorTip:
        "Please upload a picture with a width / height ratio of 2 : 1 and less than 5M !",
    },
  },
  operation: {
    operationChart: {
      tableLabelList: [
        ...
        "Atmospheric pressure",
        "Operation alarm",
        "Click to skip to the alert page",
        "Maintenance alarm",
        "weather",
        "Maintenance cycle",
    ...
    chart: {
      ...
      timeList: ["1m", "5m", "10m", "30m", "1h", "2h", "4h"],
    },
    operationalChartDaily: {
      title: "Operation and maintenance diagram",
      ...
      chartList: {
        title: [
          "Unit operation rules",
          "Start-up reliability",
          "Maintenance beat",
          "Matching power",
        ],
        describe: [
          "By understanding the rules of the unit, it is possible to guess the working hours of the customer and confirm the maintenance pace, communication, and other time constraints.",
          "Evaluate the impact on the start-up of unit equipment by observing environmental temperature and pressure information",
          "Understanding the maintenance rhythm of fuel and filters by checking fuel consumption and intake air filtration resistance",
          "Learn about the active power and reactive power in each period of a day, and match the contract, power limit, rated power, and standby power",
        ],
        tips: [
          [
            "Through the active power display of the current unit in each time of the day, so as to understand the customer's daily electricity consumption, peak consumption, user stability period, etc.",
            "Active power: Unit KW.",
          ],
          null,
          [
            "Inlet air filtration resistance: used to check the severity of the environment, by viewing the size of the resistance to determine whether it is necessary to clean the filter, such as: resistance increases to 88Pa, you need to clean.",
            "Fuel consumption: Used to predict fuel consumption, by observing fuel consumption usage, you can know when to do fuel treatment in a day.",
          ],
          [
            "Check the customer's load situation, understand the customer's load usage, accurately match the power range for the customer, and provide proof of charges for the excess power beyond the contract.",
            "Contract power (w1) : the power used by the customer when the lease project is initiated.",
            "Limited power (w2): Set the genset to operate within a reasonable power range to prevent equipment damage caused by excessive power operation.",
            "Rated power (w3): The factory rated power of the genset",
            "Backup power (w4): The maximum power value that the genset can reach",
            "Active power: Active power refers to the actual amount of AC energy generated or consumed per unit of time, and is the average power during a cycle. Check the active load situation.",
            "Reactive power: the load of the motor at the customer's device",
          ],
        ],
        dataItems: [
      ...
      curveOpt: [
        ...
        "Water Jacket heater current",
        "Water Jacket heater water temperature",
        ...
        "Waste liquid tank level",
        "U-shaped oil pan oil level",
        ...
        "Total active Power",
        "Power generation phase current",
        "Generating frequency",
        "Power generation phase voltage",
        "Power generation line voltage",
      ...
      totalDataObj: [
        "Cumulative refueling times of genset",
        "Cumulative fuel consumption of genset",
        "Cumulative running time of genset",
        "Cumulative generating capacity of genset",
        "Cumulative no fault time of the genset",
        "Cumulative overpower time of genset",
        "Cumulative average energy consumption of genset",
        "Cumulative low load operation time of genset",
        "Cumulative high load running time of genset",
      ],
      chart: {
    ...
    operationalChartWeekly: {
      title: "Operation and maintenance diagram",
      buttonLabelList: [
        "Click to skip to the project maintenance policy configuration page",
      ...
      reliability: [
        ...
        "Judging and observing the reliability of starting based on the voltage drop of the battery and the successful start time",
      ],
      errorTip2:
        "Failed to obtain alarm record information, please check the network",
      chartList: {
        title: [
          "Customer work pattern",
          "Load pattern",
          "Optimize maintenance strategy",
        ],
        describe: [
          "By understanding customer patterns, we can guess their working hours and confirm maintenance schedules, communication, and other time constraints.",
          "Display the load situation of the past 7 days through active and reactive power indicator data",
          "Optimizing maintenance strategies for fuel and filters by examining fuel consumption and intake air filtration resistance",
        ],
        tips: [
          [
            "By displaying the active power and power generation of the current unit at various times, we can understand the daily electricity consumption of customers, including peak periods and stable periods",
            "Active power: The maximum active power value per unit time, in kW",
            "Power generation: The cumulative total power generation per unit time, in kW · h",
            "Note: In the customer work pattern chart, since the maximum active power is taken, the power generation in this chart is not equal to the active power * time",
          ],
          [
            "Check the customer's load situation, understand the customer's load usage, accurately match the power range for the customer, and provide proof of charges for the excess power beyond the contract.",
            "Contract power (w1) : the power used by the customer when the lease project is initiated.",
          ...
          [
            "By viewing fuel consumption, air intake filtration resistance, fuel water content and other indicators, observe the change of a week, can be used to optimize the maintenance strategy.",
            "Inlet air filtration resistance: used to check the environmental nausea, by looking at the size of the resistance to determine whether it is necessary to clean the filter, such as: resistance increases to 88Pa, you need to clean",
            "Fuel consumption: Used to predict fuel consumption, by observing fuel consumption usage, you can know when to do fuel treatment in a day.",
            "Fuel moisture content: The proportion of water in the fuel.",
          ],
        ],
        dataItems: [
    ...
    gensetLock: {
      title: ["Genset information", "Remote unlock", "lock record"],
      operateButton: ["lock", "unlock"],
      gensetInfoList: [
        "Genset name",
        "Cloud module Logo",
        "Engine model",
      ...
      dialog: {
        tip: [
          ...
          "After performing a remote lock operation, the genset will not be able to start again. Please operate with caution",
          "Locking Reason",
    ...
    cloudMessagePush: {
      addButtonLabel: "Add push message",
      attentions:
        "The current controller currently does not support cloud message push",
      columnsList: [
        "Equipment name",
        "Carousel Content",
        "Carousel duration",
      ...
      dialog: {
        ...
        attentions: 'Pay attention to replacing the template "---"',
        attentions2:
          "If the carousel duration is set to 0 or not filled in, it means permanent carousel",
      },
      mouldList: [
        "Business consultation: For maintenance and technical issue, please contact xxx",
        "Acceptance reminder: The genset has completed delivery and acceptance, and payment for acceptance is required according to the contract, please contact xxx",
        "Warranty reminder: The one-year (/1500 hour) warranty period for this genset has expired, and the warranty deposit needs to be paid according to the contract. Please contact xxx.",
        "Reminder Warning: This genset is in arrears and there is a risk of shutdown. Please contact xxx",
        "Reliability reminder: There is a risk of failure in the ** components of this genset,  please maintain or replace in time.",
        "Lease payment reminder: Lease payment needs to be paid according to the contract. Please contact xxx.",
        "Maintenance reminder: The maintenance of this genset will expire in ** hours, please maintenance in time or contact xxx",
        "Please contact xxx for purchasing original spare parts.",
        "Please contact xxx for purchasing professional oil procurement.",
        "Please contact xxx for purchasing original triple filters.",
        "The weather is cold, please pay attention to adding antifreeze.",
        "The cooling water temperature is too high, please pay attention to adding cooling water.",
        "The oil pressure is too high, please replace the oil and filter.",
        "The oil pressure is low, please pay attention to adding oil.",
        "This genset is difficult to start, please maintain the starting battery.",
        "Others",
      ],
    },
    feedback: {
      ...
      confirm: {
        ...
        tip: "Are you sure to close the current work order?",
        successMes: "Closing the work order successfully",
        errorMes: "Failed to close the work order. Please try again",
      },
      ...
      formTip: [
        "Upload only",
        "picture（s）",
        "Upload file size not exceeding 5MB!",
      ],
      typeOpt: ["project suggestion", "complaint", "others"],
      statusOpt: ["Pending", "To be confirmed", "Closed"],
      columnsList: ["title", "content", "confirm time"],
    },
    remoteTuning: {
      list: {
        ...
        operate: ["Confirm", "parameter tuning", "Historical record"],
        columns: [
        ...
        tips: ["Are you sure?", "Are you sure you want to delete it?"],
      },
      history: {
        infoLabel: [
          "Genset name",
      ...
      operation: {
        ...
        tabList: ["Parameters", "Function", "Curve", "measure", "maintenance"],
      },
    },
    deteriorationAnalysis: {
      tabList: [
        "Analysis of water tank deterioration",
        "Analysis of oil filter deterioration",
        "Analysis of battery degradation",
      ],
      timeLabel: ["today", "This week", "This month", "This year"],
      dataLabel: ["Diagnostic indicator", "Deterioration indicator"],
    },
    leaseGenset: {
      searchForm: [
        "Genset No.",
        "Running status",
        "Lease status",
        "Genset location screening",
        "Lease type",
      ],
      searchFormPlaceholder: [
        "Please enter the genset number",
        "Please select the running status",
        "Please select lease status",
        "Please select genset location",
        "Please select the lease type",
      ],
      runStatusEnum: ["Offline", "Stop", "Risk", "Fault", "Run"],
      leaseStatusEnum: [
        "To be leased",
        "Under lease",
        "Repair",
      ...
      addTitle: [
        "Addition of genset",
        "Optional genset in public cloud",
        "Selected gensets",
        "Editing genset",
      ],
      addSearchForm: ["Equipment name", "Logo", "Genset location"],
      ...
      tips: [
        ...
        "Edit failed!",
        "Removal of genset",
        "Are you sure to remove the current genset?",
        "Genset removed successful!",
        "Failed to remove the genset, please try again!",
      ],
    },
    maintenanceMonitor: {
      ...
      operate: [
        "Open",
        "Close",
        "Forced automatic oil replenishment and change",
      ],
      monitorItemMethanol: [
        "Percentage of base gasoline tank liquid level",
        "Percentage of liquid level of methanol tank in base",
        "Percentage of methanol depletion sensor level",
      ],
      monitorItem: {
        0: ["Water content", "Fuel drainage", "Drainage solenoid valve"],
        1: ["Air intake pipe air ratio", "Fuel presupply"],
        2: [
          "Fuel depletion sensor",
          "Fuel tank allowance",
          "Fuel refill",
        ...
        6: [
          "Remaining fuel tank to be filtered",
          "Oil pan drain",
          "Oil pump for oil tank to be filtered",
          "Waste oil tank drain",
          "Waste oil pump",
        ],
        7: ["Waste liquid tank level"],
      },
      tips: [
        "No camera",
      ...
      IMRDialogColumns: [
        ...
        "End time",
        "Water content",
        "Air intake pipe air ratio",
        "Fuel surplus",
        "Oil pan oil level",
        "New fuel tank allowance",
        "New fuel tank %",
        "Remaining fuel tank to be filtered",
        "Oil tank to be filtered %",
        "Waste liquid tank allowance",
        "Waste liquid tank %",
        "Battery voltage",
      ],
      dealDialogLabel: [
        "Real-time monitoring processing registration",
        "Processing registration",
        "Processing record",
        "Please select a processed real-time monitoring event",
        "Remarks description",
        "Processing issue",
      ],
      ...
      simulationView: {
        ...
        1: ["Oil inlet pipe liquid level", "Fuel presupply"],
        2: [
          "Engine temperature",
          "Air intake resistance",
          "Feed surplus",
        ...
        3: ["Drainage percentage", "Fuel drainage", "Drainage solenoid valve"],
        4: [
          "Replenishment tank",
          "Oil pan replenishment",
          "Oil refill pump",
        ...
        7: ["Base methanol tank", "Base fuel tank"],
      ...
      maintenanceView: {
        ...
        label_2: [
          "New oil pump",
          "Oil pan oil",
          "The refueling oil tank can still be drained",
          "The oil pan oil can still be replenished",
        ],
        label_3: [
          "Waste oil pump",
          "Fuel tank to be filtered",
          "The oil pan oil can still be drained",
          "The oil tank to be filtered can still be drained",
        ],
        label_4: [
          "Dewatering pump",
          "Liquid waste tank",
        ...
        label_5: [
          ...
          "Replenishment tank",
          "The oil tank can still be replenished",
        ],
        label_6: [
        ...
        label_7: [
          "External fuel pump",
          "Base fuel tank",
          "The fuel can still be replenished",
        ],
      },
    },
    powerQuality: {
      ...
      searchLabel: [
        ...
        "select all.",
        "Parameter selection",
        "No relevant data is found. Please modify the query conditions",
      ],
      apfParamsGroupList: {
        item_0: {
          typeName: "Generator side",
          props: [
            "Power side A-phase current distortion rate",
            "Power side B-phase current distortion rate",
            "Power side C-phase current distortion rate",
            "",
            "Power side A-Phase voltage",
            "Power side B-Phase voltage",
            "Power side C-Phase voltage",
            "",
            "Power side A-Phase current",
            "Power side B-Phase current",
            "Power side C-Phase current",
            "",
            "Power side A-Phase factor",
            "Power side B-Phase factor",
            "Power side C-Phase factor",
            "",
            "Power side total power factor",
            "Power side unbalance of negative current sequence",
            "Power side unbalance of zero current sequence",
            "",
            "Motor bearing temperature",
            "U-phase winding temperature",
            "V phase winding temperature",
        ...
        item_1: {
          typeName: "Load side",
          props: [
            "Load side A-phase current distortion rate",
            "Load side B-phase current distortion rate",
            "Load side C-phase current distortion rate",
            "Load side A-phase current",
            "Load side B-phase current",
            "Load side C-phase current",
            "Load side A-phase power factor",
            "Load side B-phase power factor",
            "Load side C-phase power factor",
            "Load side total power factor",
            "Load side unbalance of negative current sequence",
            "Load side unbalance of zero current sequence",
          ],
        },
        item_2: {
          ...
          props: [
            "Harmonic analysis Total harmonic distortion rate",
            "Harmonic analysis fundamental component",
      ...
      paramsOptionsList: [
        ...
        "APF load side three-phase current distortion rate",
        "APF load side three-phase current",
        "APF power side three-phase current distortion rate",
        "APF power side line voltage",
        "APF power side phase voltage",
        "APF communication status",
        "Unbalance of APF load current zero sequence",
        "Unbalance of APF load current negative sequence",
        "Motor bearing temperature",
        "U-phase winding temperature",
        "W phase winding temperature",
        "V phase winding temperature",
        "APF power A-phase power factor",
        "APF power B-phase power factor",
        "APF power C-phase power factor",
        "APF power total power factor",
        ...
        "Total reactive Power",
        "Total active Power",
        "Unbalance of APF mains current zero sequence",
        "Unbalance of APF mains current negative sequence",
        "Power side APF A-phase A current",
        "Power side APF B-phase A current",
        "Power side APF C-phase A current",
      ],
      tips: [
        "Are you sure to click the control button?",
        "Submission, please wait...",
      ],
    },
    spotInspection: {
      columns: [
      ...
      operate: ["details"],
      detailColumns: ["Inspection project", "Inspection result"],
      result: ["Abnormal", "Normal", "Ignored"],
      title: [
